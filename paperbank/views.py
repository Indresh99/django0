...
from .models import strings, cse1, cse2, cse3, cse4, cse5, cse6, cse7, cse8, bca1, bca2, bca3, bca4, bca5, bca6, \
    biotech1, biotech2, biotech3, biotech4, biotech5, biotech6, biotech7, biotech8, civil1, civil2, civil3, civil4, \
    civil5, civil6, civil7, civil8, it1, it2, it3, it4, it5, it6, it7, it8, mech1, mech2, mech3, mech4, mech5, mech6, \
    mech7, mech8, electronics1, electronics2, electronics3, electronics4, electronics5, electronics6, electronics7, \
    electronics8
...
def detail(request, id):
    ...
    dataa = {'cse1': csee1, 'cse2': csee2, 'cse3': csee3, 'cse4': csee4, 'cse5': csee5, 'cse6': csee6, 'cse7': csee7,
             'cse8': csee8,
             'bca1': bcaa1, 'bca2': bcaa2, 'bca3': bcaa3, 'bca4': bcaa4, 'bca5': bcaa5, 'bca6': bcaa6,
             'biotech1': biotechh1, 'biotech2': biotechh2, 'biotech3': biotechh3, 'biotech4': biotechh4,
             'biotech5': biotechh5, 'biotech6': biotechh6, 'biotech7': biotechh7, 'biotech8': biotechh8,
             'civil1': civill1, 'civil2': civill2, 'civil3': civill3, 'civil4': civill4, 'civil5': civill5,
             'civil6': civill6, 'civil7': civill7, 'civil8': civill8,
             'it1': itt1, 'it2': itt2, 'it3': itt3, 'it4': itt4, 'it5': itt5, 'it6': itt6, 'it7': itt7, 'it8': itt8,
             'mech1': mechh1, 'mech2': mechh2, 'mech3': mechh3, 'mech4': mechh4, 'mech5': mechh5, 'mech6': mechh6,
             'mech7': mechh7, 'mech8': mechh8,
             'elec1': elec1, 'elec2': elec2, 'elec3': elec3, 'elec4': elec4, 'elec5': elec5, 'elec6': elec6,
             'elec7': elec7, 'elec8': elec8,
             'str': str, 'name': id}
    return render(request, 'music/detail.html', dataa)


def blank(request, id):
    return render(request, 'music/blank.html')
